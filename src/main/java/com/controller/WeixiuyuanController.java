...
public class WeixiuyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WeixiuyuanEntity user = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("weixiugonghao", username));
    ...
    public R register(@RequestBody WeixiuyuanEntity weixiuyuan){
    	...
    	WeixiuyuanEntity user = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("weixiugonghao", weixiuyuan.getWeixiugonghao()));
		if(user!=null) {
